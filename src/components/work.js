...
const Work = () => (
    ...
    <div className="row">
        ...
        <main className="works" id='work'>
            ...
            <WorkInstance title={'totaliser'} text='A minimal, lightweight, and easy to use calculator built to use in your browser.' link={'https://totaliser.netlify.app/'} >
                <StaticImage className="work__img" src="../images/work/totaliser.png" alt="totaliser" placeholder="blurred" />
            </WorkInstance>


            <WorkInstance title={'gitpod clone'} text='Always ready to code gitpod is an cloud based IDE built on top of thiea. ' link={'https://gitpodclone.netlify.app/'}>
